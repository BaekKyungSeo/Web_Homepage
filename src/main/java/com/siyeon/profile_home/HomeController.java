package com.siyeon.profile_home;
...
import com.siyeon.profile_home.dao.IDao;
import com.siyeon.profile_home.dto.MemberDto;
...
public class HomeController {
	...
	public String loginOk(HttpServletRequest request, Model model) {		
		...
		MemberDto memberDto = dao.loginOkDao(request.getParameter("id"));	//로그인 창에서 가져오기 때문에 mId가 아닌 id를 넣어준다
		...
		if (checkPw == 1) {
			...
			model.addAttribute("id", memberDto.getmId());
